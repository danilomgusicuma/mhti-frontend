...
const Feeling = React.forwardRef<HTMLDivElement,CoverProps>((props, ref) => <FeedbackSection {...props} ref={ref}>
  <Logo/>
  ...
  <SectionStack alignItems="left" style={{marginLeft: "200px"}}>
    <TypographyH2 color='#072139'>How are you feeling lately?</TypographyH2>
    <TypographyBody1 style={{width: "550px", margin: "0"}}>
          Your answers are somewhat similar to the ones given by most people who have been diagnosed with some kind of mental disorder.
      Remember that this is not a diagnosis, but if you feel like it ressonates with what you've been feeling lately, remember that there's no shame in seeking professional help, and that you should always prioritize your well being!
