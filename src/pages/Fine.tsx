...
const Fine = React.forwardRef<HTMLDivElement,CoverProps>((props, ref) => <FeedbackSection {...props} ref={ref}>
  <Logo/>
  ...
  <SectionStack alignItems="left" style={{marginLeft: "200px"}}>
    <TypographyH2 color='#072139'>Hey, everything seems fine! :)</TypographyH2>
    <TypographyBody1 style={{width: "550px", margin: "0"}}>
          Your answers are not very similar to the ones given by most people who have been diagnosed with some kind of mental disorder.
      Even so, remember that there's no shame in seeking professional help if you feel like you should, and that you should always prioritize your well being!
